...
int main()
{
    ...
    placementSuccess &= gameField.place_ship(shipManager.get_ship(1).get(), 2, 2, Orientation::Vertical);

    placementSuccess &= gameField.place_ship(shipManager.get_ship(2).get(), 5, 5, Orientation::Horizontal);
